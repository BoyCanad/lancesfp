...
export default function MusicPlayer() {
  ...
  return (
    <div className="music-player-container">
      ...
      {/* Bottom right trailing button */}
      <div className="bottom-corner-btn">
        <button
