...
export default function PareKoDetail() {
  const movie = featuredMovies.find((m) => m.id === 'f7');
    ...
    <div className="mdetail-page-wrapper">
      ...
      <div className="mdetail-content">
        ...
        <div className="mdetail-actions">
          <Link to={`/watch/pare-ko`} className="mdetail-btn mdetail-btn-play" style={{ textDecoration: 'none' }}>
